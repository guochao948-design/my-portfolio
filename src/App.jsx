...
// 修改：增加了 link 属性的支持
const SpotlightCard = ({ title, desc, icon, category, tags = [], image = null, link = null, className = "", isDarkMode }) => {
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                // 修改：更新了站酷的真实链接
                { name: '站酷 ZCOOL', handle: 'zcool.com.cn/u/17233702', icon: <LucideImage size={20}/>, link: 'https://zcool.com.cn/u/17233702' },
